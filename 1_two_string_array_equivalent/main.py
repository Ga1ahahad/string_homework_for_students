...
def is_array_string_are_equal(array_string_1: list[str], array_string_2: list[str]) -> bool:
    array_comparison = ['','']
    for string1 in array_string_1:
        array_comparison[0] = array_comparison[0] + string1
    for string2 in array_string_2:
        array_comparison[1] = array_comparison[1] + string2
    return array_comparison[0].lower() == array_comparison[1].lower()